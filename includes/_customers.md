...
keyword |  string | Customer search term. Used to search in customer name and email only. If your keywords contain special characters, it may make sense to URL encode them before making a request
