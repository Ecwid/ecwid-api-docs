...
The signature is an encoded string generated by concatenating the following webhook data (with no delimiter):
...
4. Compare teh resulting string with the received webhook signature. 
